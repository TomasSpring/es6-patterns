...
import View from '../source-item/NewsView';
import NewsController from '../source-item/NewsController';
...
export default (sources) => {
    ...
    let newsInstance1 = new News("news");
   ...
   let newsView = new View(newsInstance1);
   let newsCrtl = new NewsController (newsInstance1);
   newsCrtl.initNewsInstance(sources);
